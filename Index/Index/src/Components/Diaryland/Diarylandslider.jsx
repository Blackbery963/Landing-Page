      ...
      <Slider {...settings}>
        {slides.map((slide, index) => (
          <div key={index} className="md:p-4 p-1">
            <div
              className="w-full h-[225px] sm:h-[300px] md:h-[300px] lg:h-[350px] bg-cover bg-center rounded-lg shadow-lg relative pb-4" 
              style={{ backgroundImage: `url(${slide.image})` }}
            >
               <div className="text-center text-white h-full w-full items-center flex justify-end flex-col px-4">
              <div className=" w-full h-[30%] bg-black/15 backdrop-blur-md items-center flex-col flex justify-center rounded-md p-2">
