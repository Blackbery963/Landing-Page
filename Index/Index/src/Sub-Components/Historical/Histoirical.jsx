...
function Historical() {
    ...
    <div className='h-screen w-screen overflow-x-hidden'>
      ...
      <div className='h-screen w-full bg-center bg-cover' style={{ backgroundImage: `url(${BackImg})` }}>
          ...
          <Link to='/'>
           ...
           <button 
            ...
            >
             ...
             <span className="hidden sm:inline">Historical Art Gallery</span> 
            </button>
          </div>
        </header>
        {/* Hero Section */}
        <main className='flex flex-col items-center justify-center h-full px-4 text-center'>
          ...
          Whispers of the Past in Art
          </h1>
          <h5 className='font-Carattere font-normal text-[20px] md:text-[28px] text-[#ffffff] mt-4 drop-shadow-md animate-fade-in delay-200'>
          Each painting breathes life into history, preserving timeless moments that connect us to the stories, struggles, and triumphs of those who came before us.
          </h5>
          <button 
  ...
  <div className='max-w-7xl mx-auto text-center mb-12'>
    <h2 className='text-2xl md:text-3xl font-bold font-Playfair text-gray-800 mb-4'>The Timeless Legacy of History Captured in Art</h2>
    <p className='text-base md:text-lg text-gray-600'>
    Through each brushstroke, the past is brought to life, preserving the stories of ancient civilizations, powerful moments, and human emotions that have shaped our journey through time.
    </p>
  </div>
