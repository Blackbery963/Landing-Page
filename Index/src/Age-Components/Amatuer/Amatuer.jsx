...
// import backgroundImage from '/home/swarnadip/Documents/Index/Index/Index/src/Age-Components/Amatuer/Amatuer-images/set-art-supplies-abstract-painting.jpg'
...
//               <span className="hidden sm:inline">Amatuer's Gallery</span>
//               </button>
//           </div>
//         </header>
...
// import { Link } from "react-router-dom";
// import { FaHome, FaUser, FaInfoCircle, FaPalette } from "react-icons/fa";
// import backgroundImage from '/home/swarnadip/Documents/Index/Index/Index/src/Age-Components/Student/Student-images/girl-with-down-syndrome-her-father-painting-easel-with-brushes.jpg'
// import Professionalslider from "/home/swarnadip/Documents/Index/Index/Index/src/Age-Components/Professional/Professionalslider.jsx";
...
//             <button className="px-2 md:px-4 md:py-2 py-1 rounded-md bg-blue-500 text-white">
//               <FaPalette className="text-xl sm:hidden" />
//               <span className="hidden sm:inline">Students' Gallery</span>
//             </button>
//           </div>
//         </header>
...
// import { Link } from "react-router-dom";
// import { FaHome, FaUser, FaInfoCircle, FaPalette } from "react-icons/fa";
// import backgroundImage from '/home/swarnadip/Documents/Index/Index/Index/src/Age-Components/Beginner/Beginner-images/mother-daughter-drawing-picture-together-park.jpg'
// import Beginnerslider from "./Beginnerslider";
...
import backgroundImage from './Amatuer-images/set-art-supplies-abstract-painting.jpg';
    ...
    <div className="min-h-screen max-w-screen overflow-x-hidden flex flex-col bg-gray-100">
        ...
        >
          ...
          <div className="flex gap-x-2 sm:gap-x-4 text-gray-800 font-playfair font-semibold">
            ...
            >
              ...
              <span className="hidden sm:inline">Amatuer Gallery</span>
            </motion.button>
          </div>
        </motion.header>
      ...
      <div className="max-w-7xl mx-auto text-center mb-12 mt-12 px-4 sm:px-8">
        ...
        <motion.p
          ...
          data-aos-delay="200"
        >
           Where Tiny Hearts Paint Big Dreams and Every Stroke Tells a Story of
           Wonder and Joy.
        </motion.p>
      </div>
