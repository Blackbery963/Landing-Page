...
import backgroundImage from './Student-images/girl-with-down-syndrome-her-father-painting-easel-with-brushes.jpg';
        ...
        >
          ...
          <div className="flex gap-x-2 sm:gap-x-4 text-gray-800 font-playfair font-semibold">
            ...
            >
              ...
              <span className="hidden sm:inline">Student Gallery</span>
            </motion.button>
          </div>
        </motion.header>
