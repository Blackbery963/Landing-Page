  ...
  return (
    <div className='h-screen w-screen overflow-x-hidden'>
      ...
      <div className='h-screen w-full bg-center bg-cover' style={{ backgroundImage: `url(${BackImg})` }}>
        {/* Navbar */}
        <header className='fixed top-0 h-[100px] w-full bg-white/20 backdrop-blur-md flex items-center justify-between px-4 md:px-6 shadow-md z-50'>
          {/* Logo Section */}
        ...
        >
          ...
          >
           ...
           <button 
            ...
            <button 
              className={`px-2 md:px-4 py-2 rounded-md transition-all bg-blue-500 text-white`}>
             <FaPalette className="text-xl sm:hidden" />
             <span className="hidden sm:inline">Abstract Gallery</span> 
            </button>
          </div>
        </header>
        {/* Hero Section */}
