...
import BackImg from '/home/swarnadip/Documents/Index/Index/Index/src/Sub-Components/Still-life/Still-life-images/baroque-style-with-tasty-fruits-assortment.jpg';
import { Link } from 'react-router-dom';
import { FaHome, FaUser, FaInfoCircle, FaWineBottle,FaSearch } from 'react-icons/fa'; // Importing icons
...
function Still_life() {
        ...
        >
          ...
          <Link to='/'>
           ...
           <button 
            ...
            >
             <FaWineBottle className="text-xl sm:hidden" />
             <span className="hidden sm:inline">Still Life Gallery</span> 
            </button>
          </div>
        </header>
        {/* Hero Section */}
  ...
  <div className='max-w-7xl mx-auto text-center mb-12'>
    <h2 className='text-2xl md:text-3xl font-bold font-Playfair text-gray-800 mb-4'>Whispers of Time – The Silent Beauty of Still Life</h2>
